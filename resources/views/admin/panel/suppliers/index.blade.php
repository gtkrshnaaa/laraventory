                                        ...
                                        <tr class="hover:bg-white/60 transition-colors duration-200">
                                            <td class="px-6 py-5 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-12 w-12">
                                                        <div class="h-12 w-12 bg-blue-50 rounded-xl flex items-center justify-center border-2 border-gray-200/50">
                                            ...
                                            <td class="px-6 py-5 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('admin.suppliers.edit', $supplier) }}" class="p-2 text-blue-600 hover:text-blue-800 bg-blue-50/30 hover:bg-blue-100/50 rounded-lg border-2 border-gray-200/30 hover:border-gray-300/50 transition-all duration-200 transform hover:-translate-y-0.5" title="Edit">
                                                    ...
                                                    <form action="{{ route('admin.suppliers.destroy', $supplier) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus supplier ini?')">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="relative group p-2 text-red-600 hover:text-red-800 bg-red-50/30 hover:bg-red-100/50 rounded-lg border-2 border-red-200/30 hover:border-red-300/50 transition-all duration-200 transform hover:-translate-y-0.5" title="Hapus">
