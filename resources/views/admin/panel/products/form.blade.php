...
<form method="POST" action="{{ $action }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $product->name) }}" required
                            class="mt-1 block w-full px-4 py-2.5 text-sm bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-300 transition-all duration-200 hover:border-blue-300/50">
                        @error('name')
                    ...
                    <div class="col-span-6">
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="3"
                                class="mt-1 block w-full px-4 py-2.5 text-sm bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-300 transition-all duration-200 hover:border-blue-300/50">{{ old('description', $product->description) }}</textarea>
                        </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <div class="mt-1 relative">
                            ...
                            <input type="number" name="price" id="price" value="{{ old('price', $product->price) }}" min="0" step="0.01" required
                                class="block w-full pl-12 pr-12 sm:text-sm bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-300 transition-all duration-200 hover:border-blue-300/50"
                                placeholder="0.00">
                        </div>
                        @error('price')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            ...
            <div class="space-y-4">
                <div class="flex items-start space-x-4">
                    <div class="flex-shrink-0">
                        <div class="h-24 w-24 rounded-xl overflow-hidden border-2 border-dashed border-blue-200 bg-blue-50/50 flex items-center justify-center">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center space-x-2">
                                <label class="cursor-pointer">
                                    <span class="px-4 py-2.5 text-sm font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-xl hover:bg-blue-100 transition-colors duration-200 flex items-center space-x-2">
    ...
    <div class="flex justify-end space-x-3 mt-6 p-6 bg-white/50 border-t border-blue-200/30 rounded-b-2xl">
