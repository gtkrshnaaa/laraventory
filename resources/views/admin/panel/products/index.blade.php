...
@section('header')
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.products.create') }}" class="rounded-xl bg-blue-600 hover:bg-blue-700 px-6 py-3 font-semibold text-white transition-colors duration-200">
...
@section('content')
    <div class="py-6 h-full">
        <div class="h-full mx-auto max-w-full">
            <div class="h-full flex flex-col bg-white/80 backdrop-blur-sm border-2 border-gray-200/50 rounded-2xl">
                        ...
                        <form x-ref="searchForm" action="{{ route('admin.products.index') }}" method="GET" class="space-y-4">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    type="text"
                                    x-model="searchQuery"
                                    class="w-full pl-12 pr-12 py-2.5 text-sm bg-white/80 backdrop-blur-sm border-2 border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-gray-300 transition-all duration-200 hover:border-gray-300/50 placeholder-gray-400"
                            ...
                            <div class="flex items-center justify-between">
                                <button type="button" 
                                    ...
                                    <template x-if="hasActiveFilters">
                                        <span class="ml-1.5 px-2 py-0.5 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">
                            ...
                            <div x-show="showFilters" 
                                 ...
                                 class="p-4 bg-white/50 border-2 border-gray-100 rounded-xl space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Kategori</label>
                                        <select x-model="selectedCategory" 
                                                class="w-full py-2.5 px-4 text-sm bg-white/80 backdrop-blur-sm border-2 border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-gray-300 transition-all duration-200 hover:border-gray-300/50">
                                ...
                                <div class="flex justify-end pt-2">
                                    <button type="button" 
                                            @click="clearFilters()" 
                                            class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border-2 border-gray-200/50 hover:bg-gray-50/80 rounded-xl shadow-sm shadow-gray-100/50 hover:shadow-gray-200/50 transition-all duration-200 mr-2">
                                        Reset
                                    </button>
                                    <button type="button" 
                                            @click="showFilters = false" 
                                            class="px-4 py-2 text-sm font-medium text-white bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 rounded-xl shadow-sm shadow-blue-200/50 hover:shadow-blue-200 transition-all duration-200">
                                        Terapkan
                                    </button>
                                </div>
                            </div>
                            ...
                            <div x-show="hasActiveFilters" class="flex flex-wrap gap-2">
                                <template x-if="selectedCategory">
                                    ...
                                    @endphp
                                    @if($categoryName)
                                        <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border-2 border-gray-200">
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200/50">
                                        <thead class="bg-white backdrop-blur-sm">
                                            <tr>
                                                ...
                                                <th scope="col" class="px-6 py-4 text-right text-xs font-semibold text-blue-700 uppercase tracking-wider">
                                                ...
                                                <tr class="hover:bg-blue-50/30 transition-colors duration-200 border-b border-gray-100/30 last:border-0">
                                                    <td class="px-6 py-5 whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            <div class="flex-shrink-0 h-12 w-12">
                                                                <div class="h-12 w-12 rounded-xl bg-blue-50/50 border-2 border-gray-200/30 overflow-hidden">
                                                    ...
                                                    <td class="px-6 py-5 whitespace-nowrap text-right text-sm font-medium">
                                                        <div class="flex justify-end space-x-2">
                                                            <a href="#" class="p-2 text-blue-600 hover:text-blue-800 bg-blue-50/30 hover:bg-blue-100/50 rounded-lg border-2 border-gray-200/30 hover:border-gray-300/50 transition-colors duration-200" title="Lihat Detail">
                                                                <i data-lucide="eye" class="w-4 h-4"></i>
                                                            </a>
                                                            <a href="{{ route('admin.products.edit', $product->id) }}" class="p-2 text-blue-600 hover:text-blue-800 bg-blue-50/30 hover:bg-blue-100/50 rounded-lg border-2 border-gray-200/30 hover:border-gray-300/50 transition-colors duration-200" title="Edit">
                                                            ...
                                                            <form action="{{ route('admin.products.destroy', $product->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus produk ini?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="p-2 text-red-600 hover:text-red-800 bg-red-50/30 hover:bg-red-100/50 rounded-lg border-2 border-red-200/30 hover:border-red-300/50 transition-colors duration-200" title="Hapus">
                                                ...
                                                <tr>
                                                    <td colspan="5" class="px-6 py-12 text-center">
                                                        <div class="flex flex-col items-center justify-center">
                                                            <div class="w-16 h-16 bg-blue-50/50 rounded-2xl border-2 border-gray-200/30 flex items-center justify-center mb-4">
