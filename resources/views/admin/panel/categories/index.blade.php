                                    ...
                                    <div x-data="{ editing: false }" class="flex items-center space-x-2">
                                        ...
                                        <template x-if="editing">
                                            <form action="{{ route('admin.categories.update', $cat->id) }}" method="POST" class="flex items-center space-x-2">
                                                @csrf
                                                @method('PUT')
                                                <input type="text" name="name" value="{{ $cat->name }}" class="px-3 py-2 bg-white/80 backdrop-blur-sm border border-transparent rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Nama" required>
                                                <input type="text" name="description" value="{{ $cat->description }}" class="px-3 py-2 bg-white/80 backdrop-blur-sm border border-transparent rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Deskripsi">
