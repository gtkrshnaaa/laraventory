                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="address" rows="3"
                                          class="mt-1 block w-full px-4 py-2.5 text-sm bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-300 transition-all duration-200 hover:border-blue-300/50">{{ old('address') }}</textarea>
