...
@section('header')
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-display font-bold text-orange-700">
                Dashboard
            </h1>
            <p class="mt-2 text-gray-600">Selamat datang kembali! Berikut ringkasan sistem inventori Anda.</p>
        </div>
        <div class="flex items-center space-x-3">
            <button class="relative group rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 px-4 py-2.5 text-sm font-medium text-white shadow-sm shadow-orange-200/50 hover:shadow-orange-200 transition-all duration-200 transform hover:-translate-y-0.5">
            ...
            <button class="p-2 rounded-xl text-orange-600 hover:text-orange-700 bg-white/80 hover:bg-orange-50 border border-orange-200/50 hover:border-orange-300/50 transition-all duration-200 transform hover:-translate-y-0.5">
...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <div class="group relative">
            <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-orange-200/50 hover:border-orange-300/50 transition-colors duration-200">
                <div class="flex items-center justify-between">
                    <div>
                ...
                <div class="mt-4 pt-4 border-t border-orange-100/50">
                    <a href="{{ route('admin.products.index') }}" class="group text-sm font-medium text-orange-600 hover:text-orange-700 transition-all duration-200 flex items-center">
                        <span class="relative">
                            Lihat semua produk
            ...
            <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-orange-200/50 hover:border-orange-300/50 transition-colors duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-2">
                            <i data-lucide="trending-up" class="w-4 h-4 text-orange-500 mr-1"></i>
                            <span class="text-sm font-semibold text-orange-600">+5.4%</span>
                            <span class="text-sm text-gray-500 ml-1">dari bulan lalu</span>
                        </div>
                    </div>
                    <div class="w-16 h-16 bg-orange-600 rounded-2xl flex items-center justify-center">
                ...
                <div class="mt-4 pt-4 border-t border-orange-100/50">
                    <a href="{{ route('admin.inventory.index') }}" class="group text-sm font-medium text-orange-600 hover:text-orange-700 transition-all duration-200 flex items-center">
                        <span class="relative">
                            Kelola stok
                            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-200"></span>
                        </span>
        ...
        <div class="group relative">
            <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-orange-200/50 hover:border-orange-300/50 transition-colors duration-200">
                ...
                <div class="mt-4 pt-4 border-t border-orange-100/50">
                    <a href="{{ route('admin.categories.index') }}" class="group text-sm font-medium text-orange-600 hover:text-orange-700 transition-all duration-200 flex items-center">
                        <span class="relative">
                            Kelola kategori
                            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-200"></span>
                        </span>
            ...
            <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-orange-200/50 hover:border-orange-300/50 transition-colors duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-2">
                            <i data-lucide="trending-up" class="w-4 h-4 text-orange-500 mr-1"></i>
                            <span class="text-sm font-semibold text-orange-600">+2.3%</span>
                            <span class="text-sm text-gray-500 ml-1">dari bulan lalu</span>
                        </div>
                    </div>
                    <div class="w-16 h-16 bg-orange-600 rounded-2xl flex items-center justify-center">
                ...
                <div class="mt-4 pt-4 border-t border-orange-100/50">
                    <a href="{{ route('admin.suppliers.index') }}" class="group text-sm font-medium text-orange-600 hover:text-orange-700 transition-all duration-200 flex items-center">
                        <span class="relative">
                            Lihat supplier
                            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-200"></span>
                        </span>
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 mb-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-orange-200/50">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="relative">
                        <select class="block w-full pl-3 pr-10 py-2 text-sm border border-transparent focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent rounded-xl bg-white/50 backdrop-blur-sm">
                ...
                <div class="h-80 bg-orange-50/30 rounded-xl flex items-center justify-center border border-orange-100/50">
                    <div class="text-center">
                        <i data-lucide="bar-chart-3" class="w-16 h-16 text-orange-400 mx-auto mb-4"></i>
        ...
        <div>
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-orange-200/50">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button class="p-2 rounded-xl text-orange-600 hover:bg-orange-50 transition-colors duration-200">
                ...
                @if(count($recent_activities ?? []) > 0)
                    ...
                    <div class="mt-6">
                        <button class="w-full px-4 py-2 text-sm font-medium text-orange-600 hover:text-orange-500 hover:bg-orange-50 rounded-xl transition-colors duration-200">
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-orange-200/50">
        ...
        @if(count($low_stock_products ?? []) > 0)
            <div class="space-y-3">
                @foreach($low_stock_products as $product)
                    <div class="flex items-center justify-between p-4 bg-orange-50/50 rounded-xl border border-orange-200/50 hover:border-orange-300/50 transition-colors duration-200">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <button class="p-2 rounded-xl text-orange-600 hover:bg-orange-100 transition-colors duration-200">
        ...
        @else
            <div class="text-center py-12 bg-orange-50/50 rounded-xl border border-orange-200/50">
                <i data-lucide="check-circle" class="w-16 h-16 text-orange-500 mx-auto mb-4"></i>
                <p class="text-orange-800 font-semibold text-lg">Semua Stok Aman! 🎉</p>
                <p class="text-orange-600 text-sm">Tidak ada produk dengan stok sedikit</p>
            </div>
        @endif
    </div>
@endsection
