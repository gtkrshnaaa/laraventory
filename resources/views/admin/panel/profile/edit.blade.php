...
@section('content')
    <div class="py-6">
        <div class="mx-auto max-w-full">
            <!-- Profile Info Card -->
            <div class="overflow-hidden bg-white/80 backdrop-blur-sm border-2 border-gray-200/50 rounded-2xl mb-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input type="text" name="name" value="{{ old('name', auth('admin')->user()->name ?? '') }}" 
                                           class="w-full pl-12 pr-4 py-2.5 text-sm bg-white/80 backdrop-blur-sm border-2 border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-gray-300 transition-all duration-200 hover:border-gray-300/50 placeholder-gray-400" 
            ...
            <div class="overflow-hidden bg-white/80 backdrop-blur-sm border-2 border-gray-200/50 rounded-2xl">
                <div class="p-8 bg-white">
                    ...
                    <form action="{{ route('admin.profile.password.update') }}" method="POST" class="space-y-6" x-data="{ showPasswords: false }">
                        ...
                        <div class="bg-blue-50 backdrop-blur-sm border-2 border-gray-200/50 rounded-xl p-4">
