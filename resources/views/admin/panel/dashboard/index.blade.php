...
@section('header')
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            <button class="rounded-xl bg-orange-600 hover:bg-orange-700 px-4 py-2 text-sm font-semibold text-white transition-colors duration-200">
...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <div class="group relative">
            <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-transparent">
                <div class="flex items-center justify-between">
                    <div>
                ...
                <div class="mt-4 pt-4 border-t border-transparent">
                    <a href="{{ route('admin.products.index') }}" class="text-sm font-medium text-orange-600 hover:text-orange-500 transition-colors duration-200 flex items-center">
                        Lihat semua produk
        ...
        <div class="group relative">
            <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-transparent">
                ...
                <div class="mt-4 pt-4 border-t border-transparent">
                    <a href="{{ route('admin.inventory.index') }}" class="text-sm font-medium text-orange-600 hover:text-orange-500 transition-colors duration-200 flex items-center">
                        Kelola stok
                        <i data-lucide="arrow-right" class="w-4 h-4 ml-1"></i>
                    </a>
                </div>
        ...
        <div class="group relative">
            <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-transparent">
                ...
                <div class="mt-4 pt-4 border-t border-transparent">
                    <a href="{{ route('admin.categories.index') }}" class="text-sm font-medium text-orange-600 hover:text-orange-500 transition-colors duration-200 flex items-center">
                        Kelola kategori
                        <i data-lucide="arrow-right" class="w-4 h-4 ml-1"></i>
                    </a>
                </div>
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 mb-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-transparent">
                ...
                <div class="h-80 bg-orange-50 rounded-xl flex items-center justify-center border border-transparent">
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-xl">
        ...
        @if(count($low_stock_products ?? []) > 0)
            <div class="space-y-3">
                @foreach($low_stock_products as $product)
                    <div class="flex items-center justify-between p-4 bg-orange-50 rounded-xl border border-orange-200/50">
        ...
        @else
            <div class="text-center py-12 bg-orange-50 rounded-xl border border-orange-200/50">
