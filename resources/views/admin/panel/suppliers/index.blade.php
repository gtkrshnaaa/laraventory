...
@section('header')
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.suppliers.create') }}" class="rounded-xl bg-orange-600 hover:bg-orange-700 px-6 py-3 font-semibold text-white transition-colors duration-200">
                                        ...
                                        <tr class="hover:bg-white/60 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-5 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('admin.suppliers.edit', $supplier->id) }}" class="p-2 text-amber-600 hover:text-amber-800 bg-amber-50/50 hover:bg-amber-100 rounded-lg transition-colors duration-200" title="Edit">
                                                    ...
                                                    <form action="{{ route('admin.suppliers.destroy', $supplier->id) }}" method="POST" onsubmit="return confirm('Hapus supplier ini?')" class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="p-2 text-red-600 hover:text-red-800 bg-red-50/50 hover:bg-red-100 rounded-lg transition-colors duration-200" title="Hapus">
